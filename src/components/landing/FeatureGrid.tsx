...
const features = [
    {
        ...
        description: "Stop guessing. Get a personalized, step-by-step career path generated by AI based on your unique strengths and interests.",
        icon: Compass,
        color: "text-blue-500",
        bg: "bg-blue-500/10",
    ...
    },
    {
        ...
        description: "Bridge the communication gap. Our dual-quiz system identifies where parents and students differ and helps find common ground.",
        icon: HeartHandshake,
        color: "text-pink-500",
        bg: "bg-pink-500/10",
        colSpan: "md:col-span-1",
    ...
    {
        title: "Govt. College Discovery",
        description: "Quality education shouldn't be expensive. Discover top-rated government colleges nearby with low fees and high placement records.",
        icon: GraduationCap,
    ...
    {
        title: "The Ultimate Career Solution",
        description: "We solve the 'What Next?' crisis. From psychometric assessments to scholarship tracking, EduPath Navigator is the only tool you need to secure your future.",
        icon: Sparkles,
        color: "text-primary",
        bg: "bg-primary/10",
    ...
    },
    {
        ...
        description: "Go beyond grades. Our scientific assessment evaluates your aptitude, personality, and emotional intelligence to find your perfect fit.",
        icon: Brain,
    ...
    },
    {
        ...
        description: "Language is no barrier to success. Access guidance, quizzes, and resources in your preferred regional language.",
        icon: Languages,
